...
| `create-skill/references/skill-validation-criteria.md` | `docs/shared/skill-authoring-best-practices.md` (line 259), `docs/claude-code/skills/extend-claude-with-skills.md`, `.claude/rules/reference-files.md`, `.claude/rules/skill-description-budget.md`, `docs/adr/0007-skill-description-budget-ceiling.md`, `wiki/knowledge/skill-listing-budget.md`, `.github/instructions/karpathy-guidelines.instructions.md`, `docs/general-llm/persuasion-principles.md` | baseline — description-budget self-check criterion added (feat/skill-description-budget-ceiling) |
...
| `improve-skill/references/skill-validation-criteria.md` | `docs/shared/skill-authoring-best-practices.md` (line 259), `docs/claude-code/skills/extend-claude-with-skills.md`, `.claude/rules/reference-files.md`, `.claude/rules/skill-description-budget.md`, `docs/adr/0007-skill-description-budget-ceiling.md`, `wiki/knowledge/skill-listing-budget.md`, `.github/instructions/karpathy-guidelines.instructions.md`, `docs/general-llm/persuasion-principles.md` | baseline — description-budget self-check criterion added (feat/skill-description-budget-ceiling) |
