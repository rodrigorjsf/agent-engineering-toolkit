---
name: init-agents
description: 'Initializes AGENTS.md hierarchy (Claude Code plugin) via subagent-driven codebase analysis. Generates minimal, scoped files per ETH Zurich AGENTS.md study.'
---
