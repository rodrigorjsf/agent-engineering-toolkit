---
name: improve-claude
description: 'Evaluates and improves existing CLAUDE.md files and `.claude/rules/`: bloat, contradictions, stale refs, missing scopes. Refactors via progressive disclosure.'
---
