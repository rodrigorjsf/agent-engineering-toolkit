---
name: improve-agents
description: 'Evaluates and improves existing AGENTS.md files (platform-agnostic). Refactors bloat, contradictions, stale refs, missing scopes via progressive disclosure.'
---
