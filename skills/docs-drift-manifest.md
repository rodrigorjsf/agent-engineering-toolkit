...
| `init-agents/references/validation-criteria.md` | `plugins/agents-initializer/agents/file-evaluator.md` (lines 23-59) | AGENTS.md-only — CLAUDE.md-specific rows deleted, hook phrasing replaced with "rely on tooling enforcement", improve-claude source ref removed (XC-11/#115) |
