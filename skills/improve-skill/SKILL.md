---
name: improve-skill
description: 'Evaluates and optimizes existing SKILL.md files against evidence-based criteria: bloat, staleness, missed best practices. Use when improving a skill.'
---
